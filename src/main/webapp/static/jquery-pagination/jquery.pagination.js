		...
		getLinks:function(current_page, eventHandler) {
			...
			if(this.opts.last_text){
				if( current_page >= interval.end-1){
					fragment.append(this.createLink(end,end, {text:this.opts.last_text, classes:"current prev"}));
				}else{
					fragment.append(this.createLink(end,end, {text:this.opts.last_text, classes:"next"}));
				}
