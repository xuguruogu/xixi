...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function pageselectCallback(page_id, jq) {
			...
			$.ajax( {
				type : "POST",
				url : "${bp}/customer/customerList?pageIndex=" + page_id,
	...
	/*
		...
		*/
		...
		//搜索
		function search(){
			$("#search_form").attr("action","${bp}/customer/customer");
			$("#search_form").submit();
		}
	</script>
  ...
  <body>
    ...
    <div class="tools">
        ...
        <li onclick="javascript:deleteRole()"><span><img src="${bp}/resource/images/t03.png" /></span>删除</li>
        </ul>--%>
